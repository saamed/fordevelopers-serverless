...
namespace Workshops
{
  public static class HttpRetrieveOrder
  {
    ...
    public static async IActionResult Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequest req,
      [Table("Orders", Connection = "StorageConnection")] CloudTable ordersTable,
      TraceWriter log)
    {
